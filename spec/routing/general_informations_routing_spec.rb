...
RSpec.describe GeneralInformationsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(:get => "/general_informations/new").to route_to("general_informations#new")
    end
    ...
    it "routes to #edit" do
      expect(:get => "/general_informations/1/edit").to route_to("general_informations#edit", :id => "1")
    end
